...
export async function POST(request:Request){try{
  ...
  const rawItems=Array.isArray(body.items)?body.items:[],rawMissing=Array.isArray(body.missingPlus)?body.missingPlus:[],rawSeen=Array.isArray(body.seenPlus)?body.seenPlus:undefined;
