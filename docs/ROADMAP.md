...
**Deliverable.** Sistema moduli e bundle; più sedi per Company; assegnazioni utenti-sedi e sede attiva; ruoli e permessi granulari; Partner completo; catalogo Item condiviso con prodotti, servizi e profili verticali; listini; documenti e allegati; audit minimo con retention configurabile; notifiche di sistema; dashboard base; email SMTP ed Excel/CSV.
