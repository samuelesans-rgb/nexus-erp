...
**Deliverable.** Sistema moduli e bundle; Configuration Engine condiviso per categorie, unità, IVA, listini, metodi e condizioni di pagamento; più sedi per Company; assegnazioni utenti-sedi e sede attiva; ruoli e permessi granulari; Partner completo; catalogo Item condiviso con prodotti, servizi e profili verticali; documenti e allegati; audit minimo con retention configurabile; notifiche di sistema; dashboard base; email SMTP ed Excel/CSV.
