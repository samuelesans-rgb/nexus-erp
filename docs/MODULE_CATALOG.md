...
| `CORE_SALES` | Sales Engine | SHARED | No | `CORE_PARTNERS`, `CORE_PRODUCTS`, `CORE_DOCUMENTS` | `/sales` | `sales.read`, `sales.create`, `sales.approve`, `sales.post` | BusinessDocument, BusinessDocumentLine, DocumentLink, DomainEvent | AVAILABLE |
| `CORE_PURCHASES` | Purchasing Engine | SHARED | No | `CORE_PARTNERS`, `CORE_PRODUCTS`, `CORE_DOCUMENTS` | `/purchases` | `purchase.read`, `purchase.create`, `purchase.receive`, `purchase.invoice` | BusinessDocument, BusinessDocumentLine, DocumentLink, DomainEvent | AVAILABLE |
...
| `CORE_TREASURY` | Tesoreria | SHARED | No | `CORE_PAYMENTS`, `CORE_PARTNERS`, `CORE_DOCUMENTS` | `/treasury` | `treasury.read`, `treasury.receipt`, `treasury.payment`, `treasury.transfer`, `treasury.reconcile`, `treasury.manage` | FinancialAccount, PaymentSchedule, FinancialMovement, FinancialAllocation, FinancialTransfer, BankStatement | AVAILABLE |
